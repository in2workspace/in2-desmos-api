...
//                    try {
//                        concatenatedHash = ApplicationUtils.calculateHashLink(currentTransactionHash, previousTransaction.getHash());
...
//            return ApplicationUtils.calculateSHA256(transactionString);
//        } catch (Exception e) {
