...
import es.in2.desmos.domain.exception.RequestErrorException;
...
import es.in2.desmos.infrastructure.configs.DLTConfig;
...
public class InitialSubscriptionsSetup {
    ...
    public Mono<Void> setBlockchainSubscription() {
        ...
        DLTAdapterSubscription dltAdapterSubscription = DLTAdapterSubscription.builder()
                .eventTypes(dltConfig.getEntityTypes())
                .notificationEndpoint(dltConfig.getNotificationEndpoint())
                .build();
