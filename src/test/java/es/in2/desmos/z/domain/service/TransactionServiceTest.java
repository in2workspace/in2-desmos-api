...
//import es.in2.desmos.domain.repositories.FailedEntityTransactionRepository;
//import es.in2.desmos.domain.repositories.FailedEventTransactionRepository;
//import es.in2.desmos.domain.repositories.TransactionRepository;
...
//        BrokerProperties.BrokerPathProperties brokerPathProperties = new BrokerProperties.BrokerPathProperties("/v2", "/entities", "/subscriptions");
//        BrokerProperties brokerProperties = new BrokerProperties("scorpio", "http://localhost:1026",
//                "http://localhost:1026", new BrokerProperties.BrokerPathProperties("/entities", "/subscriptions", "/v2"));
