...
//        BlockchainData event = BlockchainData.builder()
...
//        BlockchainData event = objectMapper.readValue(json, BlockchainData.class);
//        assertEquals("ProductOffering", event.eventType());
//        assertEquals("ec22a787d8...3365894b3c", event.organizationId());
//    }
//
...
//                + ", metadata=" + metadata + ")";
//        // Act
//        BlockchainData.DLTEventBuilder blockchainEventBuilder = BlockchainData.builder()
//                .eventType(entityType)
//                .organizationId(organizationId)
//                .entityId(entityId)
//                .previousEntityHash(previousEntityHash)
