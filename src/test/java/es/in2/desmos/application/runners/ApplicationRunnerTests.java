...
class ApplicationRunnerTests {
    ...
    @Mock
    private TrustedAccessNodesListCacheInitializator trustedAccessNodesListCacheInitializator;
    ...
    void whenApplicationIsReady_thenSetBrokerSubscriptionAndBlockchainSubscription() {
        ...
        when(trustedAccessNodesListCacheInitializator.initialize(anyString())).thenReturn(Mono.empty());
    ...
    void whenDisposeIsActive() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        ApplicationRunner localApplicationRunner  = new ApplicationRunner(apiConfig, brokerConfig, blockchainConfig, brokerListenerService, blockchainListenerService, trustedAccessNodesListCacheInitializator, dataSyncWorkflow, publishWorkflow, subscribeWorkflow, getCurrentEnvironment);
