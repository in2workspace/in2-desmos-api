...
import es.in2.desmos.application.workflows.jobs.impl.BlockchainDataSyncJobImpl;
...
class BlockchainDataSyncJobImplTests {
    ...
    void testStartBlockchainDataSyncJob_withAuditRecords() throws JsonProcessingException {
        ...
        when(dataSyncService.verifyRetrievedEntityData(eq("process123"), any(BlockchainNotification.class), eq(brokerEntity))).thenReturn(Mono.just(brokerEntity));
