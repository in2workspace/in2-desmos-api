...
@SpringBootTest
@Testcontainers
class BlockchainAdapterServiceImplTestIT {
    ...
    private final BlockchainData blockchainData = new BlockchainData(
            "ProductOffering",
    ...
    private final BlockchainSubscription blockchainSubscription = new BlockchainSubscription(
...
""";
        // Act
        blockchainAdapterServiceImpl.publishEvent("1234", blockchainData).block();
        // Assert
