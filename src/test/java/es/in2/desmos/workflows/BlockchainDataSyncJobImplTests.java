...
//    @Mock
//    private ExternalEntityRetrievalService externalEntityRetrievalService;
//    @Mock
...
//        when(externalEntityRetrievalService.getEntityFromExternalSource(processId, blockchainNotification)).thenReturn(Mono.just(brokerEntity));
